...
public class SCRecipes {
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<SawingRecipe>> SAWING = RECIPE_TYPES.register("sawmill", () -> new RecipeType<>() {
        @Override
        public String toString() {
            return SimpleCarpentry.MODID + ":sawmill";
        }
    });
}